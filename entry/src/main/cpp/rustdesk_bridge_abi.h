...
const char * rustdesk_bridge_main_start_service(int enabled, const char * server, const char * relay_server, const char * api_server);
...
void rustdesk_bridge_session_start(const char * peer_id, const char * password, const char * server, const char * relay_server, const char * api_server);
